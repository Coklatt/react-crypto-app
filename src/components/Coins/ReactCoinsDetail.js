...
class ReactCoinsDetail extends Component {
    ...
    render() {
        ...
        const chartPricesData = this.getChartData(
            pricesLoading,
            chart_data,
            'prices',
            'Prices 7 Day',
        ...
        const chartMarketCapsData = this.getChartData(
            marketCapsLoading,
            chart_data,
            'market_caps',
            'Market Caps 7 Day',
        ...
        const chartTotalVolumesData = this.getChartData(
            totalVolumesLoading,
            chart_data,
            'total_volumes',
            'Total Volumes 7 Day',
                    ...
                    <Content style={contentStyle}>
                        {loading ? (
                            ...
                            <React.Fragment>
                                ...
                                <Paragraph>Last 7 days in USD. Locale datetimes.</Paragraph>
                                <Line data={chartPricesData} options={chartOptions} />

                                <Title level={3} style={titleStyle}>
                                    Market Caps Chart
                                </Title>
                                <Paragraph>Last 7 days market caps. Locale datetimes.</Paragraph>
                                <Line data={chartMarketCapsData} options={chartOptions} />

                                <Title level={3} style={titleStyle}>
                                    Total Volumes Chart
                                </Title>
                                <Paragraph>Last 7 days total volumes. Locale datetimes.</Paragraph>
